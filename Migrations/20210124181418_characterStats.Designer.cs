...
namespace taleOfDungir.Migrations
{
    ...
    [Migration("20210124181418_characterStats")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("taleOfDungir.Models.Character", b =>
                {
                    ...
                    b.Property<long>("CharacterAvatarId")
                        .HasColumnType("bigint");

                    b.Property<long>("CharacterMetaDataId")
                        .HasColumnType("bigint");

                    b.Property<byte[]>("CharacterStats")
                        .HasColumnType("bytea");
            ...
            modelBuilder.Entity("taleOfDungir.Models.CharacterMetaData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTime>("BlackSmithItemGenerationTime")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("taleOfDungir.Models.Event", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("taleOfDungir.Models.EventAction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("taleOfDungir.Models.ImageDBModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("taleOfDungir.Models.Mission", b =>
                {
                    ...
                    b.Property<bool>("EventsFinished")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("taleOfDungir.Models.CharacterMetaData", b =>
                {
                    b.HasOne("taleOfDungir.Models.Character", null)
                        .WithOne("CharacterMetaData")
                        .HasForeignKey("taleOfDungir.Models.CharacterMetaData", "CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("taleOfDungir.Models.EventAction", b =>
                {
                    b.HasOne("taleOfDungir.Models.Event", null)
